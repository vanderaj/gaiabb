/*******************************************************************************
 * DHTML progress bar script Written by Mark Wilton-Jones, 1-2/10/2002 Version
 * 1.0.1 Updated 5/01/2007 to work in strict mode
 * ****************************************************************************************
 *
 * Please see http://www.howtocreate.co.uk/jslibs/ for details and a demo of
 * this script Please see http://www.howtocreate.co.uk/jslibs/termsOfUse.html
 * for terms of use
 *
 * This script can produce an unlimited number of progress bars on the page, all
 * highly configurable.
 *
 * To use:
 *
 ...
 *
 * <script type="text/javascript"> var myProgBar = new progressBar( 1, //border
 * thickness '#000000', //border colour '#a5f3b1', //background colour
 * '#043db2', //bar colour 400, //width of bar (excluding border) 20, //height
 * of bar (excluding border) 1 //direction of progress: 1 = right, 2 = down, 3 =
 * left, 4 = up ); </script>
 *
 ...
 * myProgBar.setCol('#ff0000'); //change the colour of the progress bar alert(
 * 'Current progress is ' + myProgBar.amt ) // read current progress
 *
 * </script>
