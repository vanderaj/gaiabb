...
$lang_code = $lang_dir = $lang_align = $lang_noalign = $charset = '';
$lang = array();

function setupLanguage()
{
    global $lang_code, $lang_dir, $lang_align, $lang_noalign, $charset, $lang;
    global $CONFIG;
    ...
    $lang['admin_fix_favorites_title'] = 'Fix Orphaned Favorites';
    $lang['admin_fix_favorites_confirm'] = 'Are you sure you want to delete all orphaned favorites?';
    $lang['admin_fix_orphanedposts_title'] = 'Fix Orphaned Posts';
    $lang['admin_fix_orphanedposts_confirm'] = 'Are you sure you want to delete all orphaned posts?';
    $lang['admin_fix_subscriptions_title'] = 'Fix Orphaned Subscriptions';
    $lang['admin_fix_subscriptions_confirm'] = 'Are you sure you want to delete all orphaned subscriptions?';
    ...
    $lang['no_templates'] = "templates.gbb template file was not found.";
    ...
    $lang['templaterestoreconfirm'] = "Are you sure you want to restore the templates to their default state in <strong>templates.gbb</strong>? <strong>templates.gbb</strong> must be in your forums directory for this to work!";
    $lang['templates'] = "Templates";
    $lang['templatesdelete'] = "Template deleted successfully.";
    $lang['templatesrestoredone'] = "All templates have been restored to the ones in templates.gbb.";
    ...
    $lang['template_rescur_text'] = "This will let you restore you current, up-to-date templates.<br />Without having to do a back and re-upload the <strong>templates.gbb</strong> file.<br /><br />Please note, the file <strong>templates-current.gbb</strong> must be in the <br />templates folder for this to work.";
    $lang['template_current_no'] = "The file <strong>templates-current.gbb</strong> was not found within the <strong><em>templates</em></strong> folder.";
    $lang['template_current_up'] = "All templates have been restored to the ones in <strong>templates-current.gbb</strong>.";
    $lang['template_backupcur'] = "Backup Current";
    $lang['template_baccur_text'] = "This will let you backup you current, up-to-date templates.<br />Without having to do a back and re-upload the <strong>templates.gbb</strong> file.<br /><br />Please note, the file <strong>templates-current.gbb</strong> must be in the <br />templates folder for this to work.";
    ...
    $lang['template_current_bac'] = "All templates have been backed up to the file <strong>templates-current.gbb</strong>.";
    $lang['letterall'] = "All";
