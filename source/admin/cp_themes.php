...
if ($action == 'themes')
{
    ...
    {
        ?>
        <form method="post" action="cp_themes.php?action=themes" name="theme_main">
        ...
        while ($themeinfo = $db->fetch_array($query))
        {
            ...
            ?>
            <tr>
            <td bgcolor="<?php echo $THEME['altbg1']?>" class="ctrtablerow"><input type="checkbox" name="theme_delete[]" value="<?php echo $themeinfo['themeid']?>" /></td>
            <td bgcolor="<?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="theme_name[<?php echo $themeinfo['themeid']?>]" value="<?php echo $themeinfo['name']?>" />&nbsp;[ <a href="./cp_themes.php?action=themes&amp;single=<?php echo $themeinfo['themeid']?>"><?php echo $lang['textdetails']?></a> ]&nbsp;-&nbsp;[ <a href="./cp_themes.php?action=themes&amp;download=<?php echo $themeinfo['themeid']?>"><?php echo $lang['textdownload']?></a> ]</td>
        ...
        <td colspan="4"><a href="./cp_themes.php?action=themes&amp;single=anewtheme1"><strong><?php echo $lang['textnewtheme']?></strong></a> - <a href="#" onclick="setCheckboxes('theme_main', 'theme_delete[]', true); return false;"><?php echo $lang['checkall']?></a> - <a href="#" onclick="setCheckboxes('theme_main', 'theme_delete[]', false); return false;"><?php echo $lang['uncheckall']?></a> - <a href="#" onclick="invertSelection('theme_main', 'theme_delete[]'); return false;"><?php echo $lang['invertselection']?></a></td>
        </tr>
        <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg2']?>">
        <td colspan="4"><input type="submit" name="themesubmit" value="<?php echo $lang['textsubmitchanges']?>" class="submit" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <br />
        <form method="post" action="cp_themes.php?action=themes" enctype="multipart/form-data">
        <input type="hidden" name="token" value="<?php echo $oToken->get_new_token()?> " />
        <table cellspacing="0px" cellpadding="0px" border="0px" width="100%" align="center">
        <tr>
        <td bgcolor="<?php echo $THEME['bordercolor']?>">
        ...
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="file" name="themefile" value="" size="40" /></td>
        </tr>
        <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg2']?>">
        <td colspan="2"><input type="submit" class="submit" name="importsubmit" value="<?php echo $lang['textimportsubmit']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    else if (isset($single) && $single != 'submit' && $single != 'anewtheme1')
    {
        ...
        <td bgcolor="<?php echo $THEME['altbg2']?>" colspan="2"><input type="text" name="navsymbolnew" value="<?php echo $themedata['navsymbol']?>" /></td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textbgcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="bgcolornew" value="<?php echo $themedata['bgcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['bgcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['outerbgcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="outerbgcolornew" value="<?php echo $themedata['outerbgcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['outerbgcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textaltbg1']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="altbg1new" value="<?php echo $themedata['altbg1']?>" /></td>
        <td bgcolor="<?php echo $themedata['altbg1']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textaltbg2']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="altbg2new" value="<?php echo $themedata['altbg2']?>" /></td>
        <td bgcolor="<?php echo $themedata['altbg2']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['highlight']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="highlightnew" value="<?php echo $themedata['highlight']?>" /></td>
        <td bgcolor="<?php echo $themedata['highlight']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['spacolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="spacolornew" value="<?php echo $themedata['spacolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['spacolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['admcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="admcolornew" value="<?php echo $themedata['admcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['admcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['spmcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="spmcolornew" value="<?php echo $themedata['spmcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['spmcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['modcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="modcolornew" value="<?php echo $themedata['modcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['modcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['memcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="memcolornew" value="<?php echo $themedata['memcolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['memcolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textlink']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="linknew" value="<?php echo $themedata['link']?>" /></td>
        <td bgcolor="<?php echo $themedata['link']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textborder']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="bordercolornew" value="<?php echo $themedata['bordercolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['bordercolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['outerbordercolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="outerbordercolornew" value="<?php echo $themedata['outerbordercolor']?>" /></td>
        <td bgcolor="<?php echo $themedata['outerbordercolor']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textheader']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="headernew" value="<?php echo $themedata['header']?>" /></td>
        <td bgcolor="<?php echo $themedata['header']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textheadertext']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="headertextnew" value="<?php echo $themedata['headertext']?>" /></td>
        <td bgcolor="<?php echo $themedata['headertext']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['texttop']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="topnew" value="<?php echo $themedata['top']?>" /></td>
        <td <?php echo $topcode?>>&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textcatcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="catcolornew" value="<?php echo $themedata['catcolor']?>" /></td>
        <td <?php echo $catcode?>>&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textcattextcolor']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="cattextnew" value="<?php echo $themedata['cattext']?>" /></td>
        <td bgcolor="<?php echo $themedata['cattext']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['texttabletext']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="tabletextnew" value="<?php echo $themedata['tabletext']?>" /></td>
        <td bgcolor="<?php echo $themedata['tabletext']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['texttext']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="textnew" value="<?php echo $themedata['text']?>" /></td>
        <td bgcolor="<?php echo $themedata['text']?>">&nbsp;</td>
        </tr>
        <tr class="tablerow">
        <td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textborderwidth']?></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>" colspan="2"><input type="text" name="borderwidthnew" value="<?php echo $themedata['borderwidth']?>" size="2" /></td>
        </tr>
        <tr class="tablerow">
        ...
        <td colspan="3"><input type="submit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /><input type="hidden" name="orig" value="<?php echo $single?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
