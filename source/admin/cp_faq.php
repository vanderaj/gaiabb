...
<form method="post" action="cp_faq.php">
    ...
    foreach ($items['0'] as $item) {
        ...
        &nbsp; <?php echo $lang['textorder']?> <input type="text"
							name="displayorder<?php echo $item['fid']?>" size="2"
						...
						</select> &nbsp; <select name="moveto<?php echo $item['fid']?>"><option
									value="" selected="selected">-<?php echo $lang['textnone']?>-</option>
        <?php
        ...
        ?>
							...
							href="cp_faq.php?fdetails=<?php echo $item['fid']?>"><?php echo $lang['faq_F']?></a></td>
					</tr>
        <?php
    }
                ...
                &nbsp; <?php echo $lang['textorder']?> <input
							...
							name="status<?php echo $item['fid']?>">
								...
								<option value="off" <?php echo $off?>><?php echo $lang['textoff']?></option>
									...
									value="">-<?php echo $lang['textnone']?>-</option>
                <?php
                foreach ($groups as $moveforum) {
					...
					<tr class="tablerow">
						...
						<textarea rows="5" name="newfdesc" cols="60"><?php echo $lang['faq_J']?></textarea>
							...
							name="newforder" size="2" /> &nbsp; <select name="newfstatus">
								<option value="on"><?php echo $lang['texton']?></option>
								<option value="off"><?php echo $lang['textoff']?></option>
						</select> &nbsp; <select name="newffup"><option value=""
									selected="selected">-<?php echo $lang['textnone']?>-</option>
    <?php
    foreach ($groups as $group) {
...
<form method="post" action="cp_faq.php?gdetails=<?php echo $gdetails?>">
    ...
    <tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text"
							name="namenew" value="<?php echo $group['name']?>" /></td>
					</tr>
					<tr class="tablerow">
						<td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['textorder']?></td>
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text"
							name="displayordernew" size="2"
							value="<?php echo $group['displayorder']?>" /></td>
					</tr>
					<tr class="tablerow">
						<td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['pmreadstatus']?></td>
						<td bgcolor="<?php echo $THEME['altbg2']?>"><select
							name="groupstatusnew"><option value="on" <?php echo $on?>><?php echo $lang['texton']?></option>
								<option value="off" <?php echo $off?>><?php echo $lang['textoff']?></option></select></td>
					</tr>
					<tr class="tablerow">
						<td bgcolor="<?php echo $THEME['altbg1']?>"><?php echo $lang['faq_Q']?></td>
						<td bgcolor="<?php echo $THEME['altbg2']?>"><select name="codenew"><option
									value="" <?php echo $ic00?>>-<?php echo $lang['textnone']?>-</option>
...
<form method="post" action="cp_faq.php?fdetails=<?php echo $fdetails?>">
    ...
    <tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text"
							name="namenew" value="<?php echo $item['name']?>" size="60" /></td>
					</tr>
    ...
    <tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><textarea rows="20"
								...
								onkeyup="storeCaret(this);"><?php echo $item['description']?></textarea></td>
					</tr>
					<tr class="tablerow">
					...
					<tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><select name="viewnew"><option
									value="0" <?php echo $ic00?>>-<?php echo $lang['textnone']?>-</option>
					...
					<tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="checkbox"
							name="delete" value="<?php echo $item['fid']?>" /></td>
					</tr>
					<tr>
						<td bgcolor="<?php echo $THEME['altbg2']?>" class="ctrtablerow"
