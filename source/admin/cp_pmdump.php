...
function viewPanel()
{
    ...
    <tr>
    <td colspan="2" class="category"><strong><font color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['pmdump'] ?></font></strong></td>
    </tr>
    <tr>
    <td class="ctrtablerow" bgcolor="<?php echo $THEME['altbg2'] ?>" colspan="2"><?php echo $lang['pmdump_confirm'] ?><br /><input class="submit" type="submit" name="yessubmit" value="<?php echo $lang['textyes'] ?>" /></td>
    </tr>
    </table>
    </td>
    </tr>
