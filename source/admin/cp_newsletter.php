				...
				<table border="0px" cellspacing="<?php echo $THEME['borderwidth']?>"
					...
					<tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="radio"
							value="email" name="sendvia" /> <?php echo $lang['textemail']?><br />
						<input type="radio" value="pm" checked="checked" name="sendvia" /> <?php echo $lang['textpm']?></td>
					</tr>
					<tr class="tablerow">
						<td bgcolor="<?php echo $THEME['altbg1']?>" valign="top"
							width="25%"><?php echo $lang['textsendto']?></td>
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="radio"
							value="all" checked="checked" name="to" /> <?php echo $lang['textsendall']?><br />
					...
					<tr class="tablerow">
						...
						<td bgcolor="<?php echo $THEME['altbg2']?>"><input type="checkbox"
							value="yes" <?php echo $cheHTML?> name="newscopy" /> <?php echo $lang['newsreccopy']?><br />
						</td>
					</tr>
