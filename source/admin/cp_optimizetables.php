...
function viewPanel()
{
    ...
    ?>
    <form method="post" action="cp_optimizetables.php">
            ...
            <tr>
                <td bgcolor="<?php echo $THEME['bordercolor'] ?>">
                    <table border="0px" cellspacing="<?php echo $THEME['borderwidth'] ?>"
                        ...
                        <tr class="category">
                            <td colspan="2" class="title"><?php echo $lang['optimize'] ?></td>
                        </tr>
                        <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg1'] ?>">
                            <td colspan="2"><?php echo $lang['confirm_optimize'] ?></td>
                        </tr>
