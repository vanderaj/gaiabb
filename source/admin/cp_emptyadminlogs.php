...
nav($lang['emptyadminlogs']);
btitle($lang['textcp']);
btitle($lang['emptyadminlogs']);
...
function viewPanel()
{
    ...
    <tr class="category">
    <td colspan="2" class="title"><?php echo $lang['emptyadminlogs'] ?></td>
    </tr>
    <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg1'] ?>">
    <td colspan="2"><?php echo $lang['emptyadminlogs_confirm'] ?></td>
    </tr>
...
function doPanel()
{
    ...
    cp_message($lang['tool_adminlogs'], false, '', '</td></tr></table>', 'index.php', true, false, true);
}
