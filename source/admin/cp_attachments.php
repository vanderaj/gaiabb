...
function viewPanel()
{
    ...
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwherename']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="filename" size="30" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwhereauthor']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="author" size="40" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwhereforum']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><?php echo $forumselect?></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwheresizesmaller']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="sizeless" size="20" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwheresizegreater']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="sizemore" size="20" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwheredlcountsmaller']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="dlcountless" size="20" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwheredlcountgreater']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="dlcountmore" size="20" /></td>
    </tr>
    <tr class="tablerow">
    <td bgcolor="<?php echo $THEME['altbg1']?>" width="35%" nowrap="nowrap"><?php echo $lang['attachmanwheredaysold']?></td>
    <td bgcolor="<?php echo $THEME['altbg2']?>"><input type="text" name="daysold" size="20" /></td>
    </tr>
    <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg2']?>">
    <td colspan="2"><input type="submit" name="searchsubmit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
    </tr>
    </table>
    </td>
    </tr>
...
function doSearch()
{
    ...
    while ($attachment = $db->fetch_array($query))
    {
        ...
        ?>
        <tr>
        <td bgcolor="<?php echo $THEME['altbg1']?>" class="ctrtablerow" valign="middle"><a href="cp_attachments.php?action=delete_attachment&amp;aid=<?php echo $attachment['aid']?>&amp;token=<?php echo $oToken->get_new_token()?>"><?php echo $lang['textdeleteques']?></a>
        <td bgcolor="<?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><input type="text" name="filename<?php echo $attachment['aid']?>" value="<?php echo $attachment['filename']?>"><br /><span class="smalltxt"><a href="../viewtopic.php?action=attachment&amp;tid=<?php echo $attachment['tid']?>&amp;pid=<?php echo $attachment['pid']?>&amp;aid=<?php echo $attachment['aid']?>" target="_blank"><?php echo $lang['textdownload']?></a></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><a href="../viewprofile.php?memberid=<?php echo urlencode($attachment['author_uid'])?>" target="_blank"><?php echo $attachment['author']?></a></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><a href="../viewtopic.php?tid=<?php echo $attachment['tid']?>" target="_blank"><?php echo $attachment['tsubject']?></a><br /><span class="smalltxt"><?php echo $lang['textinforum']?> <a href="../viewforum.php?fid=<?php echo $attachment['fid']?>" target="_blank"><?php echo $attachment['fname']?></a></span></td>
        <td bgcolor="<?php echo $THEME['altbg2']?>" class="tablerow" valign="top" align="center"><?php echo $attachsize?></td>
    ...
    ?>
    <tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg2']?>">
    <td colspan="6"><input class="submit" type="submit" name="deletesubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
    </tr>
    </table>
    </td>
    </tr>
    ...
    <input type="hidden" name="author" value="<?php echo htmlentities($author)?>" />
    <input type="hidden" name="forumprune" value="<?php echo htmlentities($forumprune)?>" />
