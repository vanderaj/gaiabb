        ...
        <tr>
            <td bgcolor="<?php echo $THEME['bordercolor'] ?>">
                <table border="0px" cellspacing="<?php echo $THEME['borderwidth'] ?>"
                    ...
                    <tr class="category">
                        <td><strong><font
                                        color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['regusername'] ?></font></strong>
                        </td>
                        <td><strong><font color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['texttime'] ?></font></strong>
                        </td>
                        <td><strong><font
                                        color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['urltxt'] ?></font></strong>
                        </td>
                        <td><strong><font
                                        color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['actiontxt'] ?></font></strong>
                        </td>
                    </tr>
                    <?php
                    ...
                    while (($recordinfo = $db->fetchArray($query)) != false) {
                        ...
                        <tr>
                            ...
                            <td class="tablerow"
                                bgcolor="<?php echo $THEME['altbg2'] ?>"><?php echo $date ?><?php echo $lang['textat'] ?><?php echo $time ?></td>
                ...
                <table border="0px" cellspacing="<?php echo $THEME['borderwidth'] ?>"
                    ...
                    <tr class="category">
                        <td colspan="5"><strong><font
                                        color="<?php echo $THEME['cattext'] ?>"><?php echo $lang['textcplogs'] ?></font></strong>
                        </td>
                    </tr>
                    <tr class="header">
                    ...
                    while (($recordinfo = $db->fetchArray($query)) != false) {
                        ...
                        <tr>
                            ...
                            <td class="tablerow" bgcolor="<?php echo $THEME['altbg2'] ?>"><?php echo $date ?>
                                at <?php echo $time ?></td>
                            <td class="tablerow" bgcolor="<?php echo $THEME['altbg1'] ?>"><?php echo $url ?></td>
                            <td class="tablerow"
                                bgcolor="<?php echo $THEME['altbg2'] ?>"><?php echo $recordinfo['action'] ?></td>
