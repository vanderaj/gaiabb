...
nav($lang['textforcelogout']);
btitle($lang['textcp']);
btitle($lang['textforcelogout']);
		...
		<tr>
			<td bgcolor="<?php echo $THEME['bordercolor']?>">
				<table border="0px" cellspacing="<?php echo $THEME['borderwidth']?>"
					...
					<tr class="category">
						<td colspan="2" class="title"><?php echo $lang['textforcelogout']?></td>
					</tr>
					<tr class="ctrtablerow" bgcolor="<?php echo $THEME['altbg1']?>">
						<td colspan="2"><?php echo $lang['forcelogout_confirm']?></td>
					</tr>
...
function doPanel()
{
    ...
    cp_message($lang['forcelogoutmsg'], false, '', '</td></tr></table>', 'index.php', true, false, true);
}
