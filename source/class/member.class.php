    ...
    public function update()
    {
        ...
        if ($this->uid == 0) {
            $sql = "INSERT INTO " . X_PREFIX . "members (
                        ...
                        threadnum,
                        readrules
            " . $this->processExtraCol('insertnames') . ")" . "VALUES (" . "'" . $db->escape($this->record['username'], -1, true) . "'," . "'" . $db->escape($this->record['password']) . "'," . "'" . $db->escape($this->record['regdate']) . "'," . "'" . intval($this->record['postnum']) . "'," . "'" . $db->escape($this->record['email'], -1, true) . "'," . "'" . $db->escape($this->record['site']) . "'," . "'" . $db->escape($this->record['aim']) . "'," . "'" . $db->escape($this->record['status']) . "'," . "'" . $db->escape($this->record['location']) . "'," . "'" . $db->escape($this->record['bio']) . "'," . "'" . $db->escape($this->record['sig'], -1, true) . "'," . "'" . $db->escape($this->record['showemail']) . "'," . "'" . intval($this->record['timeoffset']) . "'," . "'" . $db->escape($this->record['icq']) . "'," . "'" . $db->escape($this->record['avatar']) . "'," . "'" . $db->escape($this->record['yahoo']) . "'," . "'" . $db->escape($this->record['customstatus']) . "'," . "'" . $db->escape($this->record['theme']) . "'," . "'" . $db->escape($this->record['bday']) . "'," . "'" . $db->escape($this->record['langfile']) . "'," . "'" . intval($this->record['tpp']) . "'," . "'" . intval($this->record['ppp']) . "'," . "'" . $db->escape($this->record['newsletter']) . "'," . "'" . $db->escape($this->record['regip']) . "'," . "'" . $db->escape($this->record['timeformat']) . "'," . "'" . $db->escape($this->record['msn']) . "'," . "'" . $db->escape($this->record['ban']) . "'," . "'" . $db->escape($this->record['dateformat']) . "'," . "'" . $db->escape($this->record['ignorepm']) . "'," . "'" . $db->escape($this->record['lastvisit']) . "'," . "'" . $db->escape($this->record['mood']) . "'," . "'" . $db->escape($this->record['pwdate']) . "'," . "'" . $db->escape($this->record['invisible']) . "'," . "'" . $db->escape($this->record['pmfolders']) . "'," . "'" . $db->escape($this->record['saveogpm']) . "'," . "'" . $db->escape($this->record['emailonpm']) . "'," . "'" . $db->escape($this->record['daylightsavings']) . "'," . "'" . $db->escape($this->record['viewavatars']) . "'," . "'" . $db->escape($this->record['photo']) . "'," . "'" . $db->escape($this->record['psorting']) . "'," . "'" . $db->escape($this->record['viewsigs']) . "'," . "'" . $db->escape($this->record['firstname']) . "'," . "'" . $db->escape($this->record['lastname']) . "'," . "'" . $db->escape($this->record['showname']) . "'," . "'" . $db->escape($this->record['occupation']) . "'," . "'" . $db->escape($this->record['notepad']) . "'," . "'" . $db->escape($this->record['blog']) . "'," . "'" . intval($this->record['views']) . "'," . "'" . $db->escape($this->record['expview']) . "'," . "'" . intval($this->record['threadnum']) . "'," . "'" . $db->escape($this->record['readrules']) . "'" . $this->processExtraCol('insertvalues') . ")";
        } else {
            $sql = "UPDATE " . X_PREFIX . "members SET " . "username = '" . $db->escape($this->record['username']) . "', " . "password = '" . $db->escape($this->record['password']) . "', " . "regdate = '" . $db->escape($this->record['regdate']) . "', " . "postnum = '" . intval($this->record['postnum']) . "', " . "email = '" . $db->escape($this->record['email']) . "', " . "site = '" . $db->escape($this->record['site']) . "', " . "aim = '" . $db->escape($this->record['aim']) . "', " . "status = '" . $db->escape($this->record['status']) . "', " . "location = '" . $db->escape($this->record['location']) . "', " . "bio = '" . $db->escape($this->record['bio']) . "', " . "sig = '" . $db->escape($this->record['sig'], -1, true) . "', " . "showemail = '" . $db->escape($this->record['showemail']) . "', " . "timeoffset = '" . intval($this->record['timeoffset']) . "', " . "icq = '" . $db->escape($this->record['icq']) . "', " . "avatar = '" . $db->escape($this->record['avatar']) . "', " . "yahoo = '" . $db->escape($this->record['yahoo']) . "', " . "customstatus = '" . $db->escape($this->record['customstatus']) . "', " . "theme = '" . $db->escape($this->record['theme']) . "', " . "bday = '" . $db->escape($this->record['bday']) . "', " . "langfile = '" . $db->escape($this->record['langfile']) . "', " . "tpp = '" . intval($this->record['tpp']) . "', " . "ppp = '" . intval($this->record['ppp']) . "', " . "newsletter = '" . $db->escape($this->record['newsletter']) . "', " . "regip = '" . $db->escape($this->record['regip']) . "', " . "timeformat = '" . $db->escape($this->record['timeformat']) . "', " . "msn = '" . $db->escape($this->record['msn']) . "', " . "ban = '" . $db->escape($this->record['ban']) . "', " . "dateformat = '" . $db->escape($this->record['dateformat']) . "', " . "ignorepm = '" . $db->escape($this->record['ignorepm']) . "', " . "lastvisit = '" . $db->escape($this->record['lastvisit']) . "', " . "mood = '" . $db->escape($this->record['mood']) . "', " . "pwdate = '" . $db->escape($this->record['pwdate']) . "', " . "invisible = '" . $db->escape($this->record['invisible']) . "', " . "pmfolders = '" . $db->escape($this->record['pmfolders']) . "', " . "saveogpm = '" . $db->escape($this->record['saveogpm']) . "', " . "emailonpm = '" . $db->escape($this->record['emailonpm']) . "', " . "daylightsavings = '" . $db->escape($this->record['daylightsavings']) . "', " . "viewavatars = '" . $db->escape($this->record['viewavatars']) . "', " . "photo = '" . $db->escape($this->record['photo']) . "', " . "psorting = '" . $db->escape($this->record['psorting']) . "', " . "viewsigs = '" . $db->escape($this->record['viewsigs']) . "', " . "firstname = '" . $db->escape($this->record['firstname']) . "', " . "lastname = '" . $db->escape($this->record['lastname']) . "', " . "showname = '" . $db->escape($this->record['showname']) . "', " . "occupation = '" . $db->escape($this->record['occupation']) . "', " . "notepad = '" . $db->escape($this->record['notepad']) . "', " . "blog = '" . $db->escape($this->record['blog']) . "', " . "views = '" . intval($this->record['views']) . "', " . "expview = '" . $db->escape($this->record['expview']) . "', " . "threadnum = '" . $db->escape($this->record['threadnum']) . "', " . "readrules = '" . $db->escape($this->record['readrules']) . "' " . $this->processExtraCol('update') . " WHERE uid = '" . intval($this->record['uid']) . "'";
        }
