...
/**
 * setBar() - sets the value of the progress bar
 *
...
/**
 * setCol() - sets the color of the progress bar
 *
                                    ...
                                    <table border="0" cellspacing="0" width="80%" cellpadding="0">
                                        <tr>
                                            <td width="101%" colspan="2"><p>
                                                    ...
                                                    <br/>
                                                    <input type="radio" name="confMethod" value="create" checked>Attempt
                                                    to create config.php for me<br/>
                                                    <input type="radio" name="confMethod" value="view">Show the proposed
                                                    configuration on screen<br/>
                                                    <input type="radio" name="confMethod" value="download">Download the
...
function view_eula($path)
{
    ...
    <tr>
        <td class="tablerow" bgcolor="#ffffff">
            <table border="0" cellspacing="0" cellpadding="0" cols="1" width="80%">
                <tr>
                    <td>
                        <p>Please read over the agreement below, and if you agree, click "I
                            agree to these terms" under the agreement.</p> <br/>
                        <br/>
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="center"><textarea cols="80" rows="15"
                                                                 wrap='soft' name="agreement"
    ...
    ?>
                        ...
                        <?php
                            ...
                            <br/>
                            <form action="index.php" method="post">
                                <input type="hidden" name="step" value="eula"> <input
                                        type="hidden" name="path" value="<?php echo $path ?>"> <input
        ...
        <td class="tablerow" bgcolor="#ffffff">Before we can proceed, please
            ...
            <form action="index.php" method="post">
                ...
                <input type="hidden" name="path" value="<?php echo $path ?>"> <input
                        type="hidden" name="step" value="backup"> <br/> <input
        ...
        <td class="tablerow" bgcolor="#ffffff">
            ...
            <form action="index.php" method="post" autocomplete="off">
                <table>
                    <tr>
                        <td>Username:</td>
                        <td><input type="text" name="frmUsername" size="32"
...
function top_box($header = 'CHANGE ME')
{
    ...
    <table border="0" cellspacing="1px" cellpadding="5px" width="100%">
    <tr>
        <td style="background-image: url(../images/problue/topbg.gif)"
            class="category"><font color="#000000"> <strong><?php echo $header ?></strong></font></td>
    </tr>
    <?php
}
...
function view_default_index()
{
    ...
    ?>
    <tr>
        <td class="tablerow" bgcolor="#ffffff">Please choose one of the
            ...
            <form action="index.php" method="post">
                ...
                <br/> <input type="radio" name="path" value="convertxmb"/>Convert
                from XMB Forum 1.9.x<br/> <input type="radio" name="path"
                                                 value="convertphpbb"/>Convert from phpBB 2.0.x<br/> <input
                        type="hidden" name="step" value="preflight"/> <input
                        type="hidden" name="noconfig" value="1"/> <br/> <input
...
function view_header($title = "GaiaBB Installer", $path)
{
                    ...
                    <tr>
                        <td width="74%"
                            ...
                            <table
                                ...
                                <tr>
                                    <td align="right" valign="bottom"><font class="smalltxt">[ <?php echo $navtext ?>
                                            ]</font></td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="navtd">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="navtd"><img src="<?php echo $installnavimg ?>"
                                                           alt="Install" title="Install Forums" border="0"/> <a
                                                href="index.php?action=install"> <font class="navtd">Install</font></a>
                                        &nbsp; <img src="<?php echo $upgradenavimg ?>"
                                                    alt="Upgrade" title="Upgrade Forums" border="0"/> <a
                                                href="index.php?action=upgrade"> <font class="navtd">Upgrade</font></a>
                                        &nbsp; <img src="<?php echo $repairnavimg ?>"
                                                    alt="Repair" title="Repair Forums" border="0"/> <a
                                                href="index.php?action=repair"> <font
                                                    class="navtd">Repair</font></a></font>
                                        &nbsp; <img src="<?php echo $convertnavimg ?>"
                                                    alt="Convert" title="Convert Forums" border="0"/> <a
                                                href="index.php?action=convert"><font class="navtd">Convert</font></a>
                                    </td>
                                    <td align="right"><a href="../index.php"><font
                                                    class="navtd">Back to: <img
                                                        src="../images/problue/home.gif" border="0"
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="97%"
           align="center">
        <tr>
            <td width="100%"><img src="../images/problue/shadow.gif"
                                  border="0" alt="" title=""/></td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <table width="100%" cellspacing="0" cellpadding="2"
                       align="center">
                    <tr>
                        <td class="nav"><a href="index.php"><?php echo $navtext ?></a>
                        </td>
                        <td align="right">&nbsp;</td>
                    </tr>
                </table>
    ...
    <table align="center">
        <tr>
            <td align="center" class="smalltxt"><br/> <br/> Powered by
                GaiaBB <br/> Copyright &copy; 2011-2020 GaiaBB Group. All rights
                reserved. <br/> <br/></td>
        </tr>
    </table> <br/></td>
    </tr>
            ...
            <table border="0" cellspacing="0" width="80%" cellpadding="0">
                <tr>
                    <td width="80%">
                        <form action="index.php" method="post">
                            <input type="hidden" name="path" value="<?php echo $path ?>"> <input
                                    type="hidden" name="step" value="conf"> <input type="hidden"
                                                                                   name="confMethod" value="skip">
                            <p>
                                <strong>Note:</strong> If you have already uploaded a correct
                                config.php, click <input type="submit"
                                                         value="Skip this step &gt;" name="skip">
                ...
                <tr>
                    <td width="80%">
                        <p>
                            <strong>Otherwise</strong> Please fill in the details and click
                            "Configure"<br/> <br/> <br/>
                ...
                <tr>
                    <td width="48%">
                        <form action="index.php" method="post" autocomplete="off">
                            <strong>Database Name</strong><br/>Name of your database<br/>&nbsp;</font>

                    </td>
                    <td width="53%"><input type="text" name="db_name" size="40"
                                           autofocus/><br/> &nbsp;</td>
                    </font>
                </tr>
                <tr>
                    <td width="48%"><strong>Database Username</font></strong><br/>User
                        used to access database<br/>&nbsp;</font></td>
                    <td width="53%"><input type="text" name="db_user" size="40"/><br/>&nbsp;</td>
                </tr>
                <tr>
                    <td width="48%"><strong>Database Password</font></strong><br/>Keep
                        this secret<br/>&nbsp;</font></td>
                    <td width="53%"><input type="password" name="db_pw" size="40"/><br/>&nbsp;</td>
                </tr>
                <tr>
                    <td width="48%"><strong>Database Host</font></strong><br/>Database
                        Host, usually &quot;<i>localhost or 127.0.0.1</i>&quot;<br/>&nbsp;</font></td>
                    <td width="53%"><input type="text" name="db_host" size="40"
                                           value="127.0.0.1"/><br/>&nbsp;</td>
                </tr>
                <tr>
                    <td width="48%"><strong>Database Type</font></strong><br/>Usually
                        MariaDB (also compatible with Oracle MySQL)</font></td>
                    <td width="53%"><?php echo $types ?><br/>&nbsp;</td>
                </tr>
                <tr>
                    <td width="48%"><strong>Table Prefix Setting</strong><br/>This
                        setting is for the table prefix, for every board you have
                        installed, this should be different<br/>&nbsp;</font></td>
                    <td width="53%"><input type="text" name="table_pre" size="40"
                                           value="gbb_"/><br/> &nbsp;</td>
                </tr>
                <tr>
                    <td width="48%"><strong>Full URL</strong><br/>If this value is
                        wrong, please change it after the forum has installed.<br/>&nbsp;</font></td>
                    <td width="53%"><input type="text" name="foo" size="40"
                                           value="<?php echo get_boardurl() ?>" readonly="readonly"/><br/>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td><input type="hidden" name="path" value="<?php echo $path ?>"/> <input
                                type="hidden" name="step" value="db"/> <input type="submit"
                                                                              value="Configure &gt;"/>
                        </form></td>
                </tr>
            </table>
