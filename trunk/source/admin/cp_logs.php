    ...
    while (($recordinfo = $db->fetch_array($query)) != false) {
        ...
        <tr>
					<td class="tablerow" bgcolor="<?php echo $THEME['altbg1']?>"><a
						href="../viewprofile.php?memberid=<?php echo $recordinfo['uid']?>"><?php echo $recordinfo['username']?></a></td>
			...
			<table border="0px" cellspacing="<?php echo $THEME['borderwidth']?>"
				...
				<tr class="category">
					<td colspan="5"><strong><font
							color="<?php echo $THEME['cattext']?>"><?php echo $lang['textcplogs']?></font></strong></td>
				</tr>
				<tr class="header">
