...
<tr>
    ...
    <tr>
					<td><br /> <br /> <input type="hidden" name="path"
						...
						value="admin"> <input type="hidden" name="type"
						value="<?php echo $action?>"> <input type="submit"
					...
					<tr>
						<td bgcolor="#FFFFFF" align="center"><br />
							<table cellspacing="0" cellpadding="0" border="0" width="97%"
								align="center">
								<tr>
									<td bgcolor="#5176B5"><table border="0" cellspacing="1"
											cellpadding="6" width="100%">
											<tr>
												<td width="74%"
													style="background-image: url(../images/problue/topbg.gif)"><table
													...
													<table width="100%" cellpadding="0" cellspacing="0">
														<tr>
															<td class="navtd"><img src="<?php echo $installnavimg?>"
																...
																href="index.php?action=repair"> <font class="navtd">Repair</font></a></font>
