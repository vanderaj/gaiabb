...
function printsetting2($setname, $varname, $value, $size, $pass = false)
{
    global $THEME, $CONFIG, $lang;
    ?>
    <tr class="tablerow">
...
function printsetting3($setname, $boxname, $varnames, $values, $checked, $multi = true)
{
    ...
    <td bgcolor="<?php echo $THEME['altbg2']?>" width="50%"><select <?php echo($multi ? 'multiple="multiple"' : '')?> name="<?php echo $boxname?><?php echo($multi ? '[]' : '')?>"><?php echo $optionlist?></select></td>
    </tr>
    <?php
}

function printsetting4($setname, $setrows, $setvarname, $setcols, $setvalue)
{
    global $THEME, $CONFIG, $lang;
    ?>
    <tr class="tablerow">
...
function printsetting5($setname, $varname, $check1, $check2)
{
    global $THEME, $CONFIG, $lang;
    ?>
    <tr class="tablerow">
...
function printsetting6($varname, $value, $checked, $setname)
{
    global $THEME, $CONFIG, $lang;

    ?>
    <input type="checkbox" name="<?php echo $varname?>" value="<?php echo $value?>" <?php echo $checked?> /><?php echo $setname?><br />
    <?php
}
...
function settingYesNo($setting, &$yes, &$no)
{
    global $CONFIG, $selHTML;
...
function themeHTML($setting, &$on, &$off)
{
